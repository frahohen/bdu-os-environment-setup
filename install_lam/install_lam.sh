...
source ${FILE_UTILS} replace_file www-data root 700 ./install_lam/resources/etc/ldap-account-manager/config.cfg /etc/ldap-account-manager/config.cfg
...
#source $(FILE_UTILS)
source ${FILE_UTILS} replace_file www-data root 600 ./install_lam/resources/var/lib/ldap-account-manager/config/lam.conf /var/lib/ldap-account-manager/config/lam.conf
